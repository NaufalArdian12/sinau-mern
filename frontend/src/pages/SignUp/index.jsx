...
export default function SignUpPage() {
    ...
    return (
        <>
            {mode === 'AUTH' ? (<div className="relative flex flex-col flex-1 p-[10px]">
                ...
                <div className="flex items-center justify-center gap-20 my-auto mt-20" >
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col w-[400px] h-fit rounded-[20px] border border-[#262A56] p-[30px] gap-7 bg-[#080A2A]">
                        <div>
                        ...
                        <hr className="border-[#262A56]" />
                        <button type="submit" className="hover:cursor-pointer w-full rounded-full border p-[14px_20px] text-center font-semibold text-white bg-[#662FFF] border-[#8661EE] shadow-[-10px_-6px_10px_0_#7F33FF_inset]">
                            Sign Up Now
                        </button>
                    </form>
