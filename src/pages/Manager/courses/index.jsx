            ...
            <section id="CourseList" className="flex flex-col w-full rounded-[30px] p-[30px] gap-[30px] bg-[#F8FAFB]">
                <div className="card flex items-center gap-5">
                    ...
                    <div className="w-full">
                        <h3 className="font-bold text-xl leading-[30px] line-clamp-1">Responsive Design Triclorem Lorem, ipsum dolor.</h3>
                    ...
                    <div className="flex justify-end items-center gap-3">
                        <a href="manage-course-materi.html" className="w-fit rounded-full border border-[#060A23] p-[14px_20px] font-semibold text-nowrap">
                            Manage
                        </a>
                    </div>
                </div>
                <div className="card flex items-center gap-5">
                    ...
                    <div className="w-full">
                        <h3 className="font-bold text-xl leading-[30px] line-clamp-1">HTMX JavaScript 2020</h3>
                        <div className="flex items-center gap-5">
                            <div className="flex items-center gap-[6px] mt-[6px]">
                                <img src="/assets/images/icons/profile-2user-purple.svg" className="w-5 h-5" alt="icon"/>
                ...
                <div className="card flex items-center gap-5">
                    ...
                    <div className="w-full">
                        <h3 className="font-bold text-xl leading-[30px] line-clamp-1">Mastering React</h3>
                        <div className="flex items-center gap-5">
                            <div className="flex items-center gap-[6px] mt-[6px]">
                                <img src="/assets/images/icons/profile-2user-purple.svg" className="w-5 h-5" alt="icon"/>
                ...
                <div className="card flex items-center gap-5">
                    ...
                    <div className="w-full">
                        <h3 className="font-bold text-xl leading-[30px] line-clamp-1">Company Profile Multilorem Lorem, ipsum dolor.</h3>
                        <div className="flex items-center gap-5">
                            <div className="flex items-center gap-[6px] mt-[6px]">
                                <img src="/assets/images/icons/profile-2user-purple.svg" className="w-5 h-5" alt="icon"/>
                                <p className="text-[#838C9D]">2,887 Students</p>
